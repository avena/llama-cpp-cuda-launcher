#!/usr/bin/env pwsh
# test-qwen2.5-coder-0.5b.ps1 - Teste para Qwen2.5-Coder-0.5B
...
$modelLabel = if ($Model) { $Model } else { "qwen2.5-coder-0.5b-instruct-q4_k_m.gguf" }

Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "  Teste: Qwen2.5 Coder 0.5B - Todos os 5 testes" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
