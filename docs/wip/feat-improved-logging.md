...
- **Nome Dinâmico:** Determina o modelo ativo (`$activeModel`) *antes* de definir o arquivo de log.
...
- [ ] **Passo 2.1: Mover Definição de Log:** Mover a criação de `$LOG_FILE` para *depois* que o modelo é selecionado (após `Show-ModelMenu`).
